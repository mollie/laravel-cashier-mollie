...
class RefundItemCollection extends Collection
{
    ...
    {
        $refundItems = $orderItems->map(fn(OrderItem $orderItem) => Cashier::$refundItemModel::makeFromOrderItem($orderItem, $overrides))->all();
    ...
    public function toNewOrderItemCollection(): OrderItemCollection
    {
        return new OrderItemCollection(
            $this->map(fn(RefundItem $refundItem) => Cashier::$orderItemModel::make([
                'process_at' => now(),
